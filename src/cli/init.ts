...
import { ensureNanogptProvider, configureMcpEnvironment } from '../providers/nanogpt.js';
  ...
  .action(async (options) => {
    ...
    try {
      ...
      if (apiKey) {
        ...
        console.log('Run with --api-key <key> to configure MCP, or use environment variable NANOGPT_API_KEY');
      }
      ...
      console.error('Error initializing nanogpt provider:', error instanceof Error ? error.message : error);
      process.exit(1);
    }
  });
